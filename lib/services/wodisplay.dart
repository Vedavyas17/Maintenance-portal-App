...
import 'package:flutter_app_1/model/wodisplaymodel.dart';
import 'package:http/http.dart' as http;
import 'package:flutter/material.dart';

class wodisplay {
  static Future<String> displayWorkOrder(String order_id) async {
    // print(order_id);
    final response = await http.post(
        Uri.parse('http://192.168.157.36:3000/mp/wodetails'),
